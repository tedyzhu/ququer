...
- [ ] 1. chat-helpers.js 新增 3 个权威格式判定纯函数
...
- [ ] 2. chat_helpers_test.js 追加 3 纯函数边界用例并固化语义
...
- [ ] 3. 收敛 message-listener.js 3 处 A 端系统消息 OR 链(C1/C2/C3)
...
- [ ] 4. 收敛 message-fetch.js 各处(C4/C5/C6/C7)
