...
/**
 * 移除 B 端错误的"您创建了私密聊天"消息(只在 isFromInvite=true 时生效)
 */
function removeWrongCreatorMessages() {
...
/**
 * 清理重复的 B 端"加入XX的聊天"消息,只保留最新一条
 *
 * 同时移除 A 端样式"XX加入聊天"(B 端不应出现)。
 */
function removeDuplicateBEndMessages() {
...
function attach(page) {
  ...
  page.removeWrongCreatorMessages = removeWrongCreatorMessages;
  page.removeDuplicateBEndMessages = removeDuplicateBEndMessages;
}
